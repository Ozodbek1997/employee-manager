...
//Serializable helps transform this java class into different types of stream because this
//class is going to be saved in a database then it is going to sent to the frontend as json
...
@Entity // this class is mapped to any database that we configured
